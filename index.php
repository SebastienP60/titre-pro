...
<body>
    ...
    <h1 class="text-center">Nos produits du moment</h1>                
        <div class="row no-gutters" id="actualsProducts">
                <img class="img-fluid col-lg-4" src="assets/img/A69987-2.jpg" />
                <img class="img-fluid col-lg-4" src="assets/img/PR2004.jpg" />
                <img class="img-fluid col-lg-4" src="assets/img/BB3313.jpg" />
        </div>
    </div>
